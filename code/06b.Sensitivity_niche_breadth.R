...
cat("\nBreadth - All data:\n")
sensitivity_data_breadth_all <- create_sensitivity_datasets(data_breadth, n_sensitivity = 5, resample_prop = 0.2)
cat("\nBreadth - Tropical data:\n")
sensitivity_data_breadth_tropical <- create_sensitivity_datasets(data_breadth_tropical, n_sensitivity = 5, resample_prop = 0.2)
cat("\nBreadth - Non-tropical data:\n")
sensitivity_data_breadth_nontropical <- create_sensitivity_datasets(data_breadth_nontropical, n_sensitivity = 5, resample_prop = 0.2)
cat("\nPosition - All data:\n")
sensitivity_data_position_all <- create_sensitivity_datasets(data_position, n_sensitivity = 5, resample_prop = 0.2)
cat("\nPosition - Tropical data:\n")
sensitivity_data_position_tropical <- create_sensitivity_datasets(data_position_tropical, n_sensitivity = 5, resample_prop = 0.2)
cat("\nPosition - Non-tropical data:\n")
sensitivity_data_position_nontropical <- create_sensitivity_datasets(data_position_nontropical, n_sensitivity = 5, resample_prop = 0.2)
...
env_breadth_plot_final <- cowplot::plot_grid(
  env_breadth_plot, legend_myco, rel_widths = c(1, 0.25)
)
...
ggsave(
  filename = "output/figure_S19.png",
  plot = env_breadth_plot_final,
  width = 12,
  height = 21,
  bg = "white",
  unit = "cm",
