...
readonly SILVA_dir="$path/data/AusMicrobiome/16S/05.Reference_dataset"         # Full 16S reference dataset subdirectory
...
# The typical length of the V1-V3 is 490bp, but can vary from ~300 to ~600 bp
# Here I allow for a range of 290-690bp to eliminate erroneous sequences, because otherwise sequences with lengths of, for example, 1 bp, as well as over 2000 bp, are produced
...
#   (1) Replace the first occurance of a spaces with a semicolon
#   (2) Eukaryota annotations are long and bizzare. Because I'm not interested
#       in Eukaryotes, I'll change all "Eukaryota" annotations uninformative
#       annotatins fit my taxonomy hierarchy after BLASTing the sequences
