...
## FILEPATH: /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/code/01.Bioinformatics_ITS/02.Extract_ITS_b6.sh
...
readonly first_run=21
readonly last_run=24
