...
## FILEPATH: /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/code/01.Bioinformatics_ITS/02.Extract_ITS_b10.sh
...
readonly first_run=37
readonly last_run=40
