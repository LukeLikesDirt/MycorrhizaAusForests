...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/16S/bpa_de0d5f3a_20230925T0948
...
if [ ! -f tmp/bpa_de0d5f3a_20230925T0948_urls.txt ]; then
  echo "tmp/bpa_de0d5f3a_20230925T0948_urls.txt not found"
  echo
...
done < tmp/bpa_de0d5f3a_20230925T0948_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_de0d5f3a_20230925T0948_md5sum.txt 2>&1 | tee tmp/md5sum.log