...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/16S/bpa_6775ac8e_20230923T1207
...
if [ ! -f tmp/bpa_6775ac8e_20230923T1207_urls.txt ]; then
  echo "tmp/bpa_6775ac8e_20230923T1207_urls.txt not found"
  echo
...
done < tmp/bpa_6775ac8e_20230923T1207_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_6775ac8e_20230923T1207_md5sum.txt 2>&1 | tee tmp/md5sum.log