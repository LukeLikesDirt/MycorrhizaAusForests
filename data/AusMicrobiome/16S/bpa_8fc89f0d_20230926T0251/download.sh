...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/16S/bpa_8fc89f0d_20230926T0251
...
if [ ! -f tmp/bpa_8fc89f0d_20230926T0251_urls.txt ]; then
  echo "tmp/bpa_8fc89f0d_20230926T0251_urls.txt not found"
  echo
...
done < tmp/bpa_8fc89f0d_20230926T0251_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_8fc89f0d_20230926T0251_md5sum.txt 2>&1 | tee tmp/md5sum.log