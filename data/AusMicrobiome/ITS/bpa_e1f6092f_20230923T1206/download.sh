...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/ITS/bpa_e1f6092f_20230923T1206
...
if [ ! -f tmp/bpa_e1f6092f_20230923T1206_urls.txt ]; then
  echo "tmp/bpa_e1f6092f_20230923T1206_urls.txt not found"
  echo
...
done < tmp/bpa_e1f6092f_20230923T1206_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_e1f6092f_20230923T1206_md5sum.txt 2>&1 | tee tmp/md5sum.log