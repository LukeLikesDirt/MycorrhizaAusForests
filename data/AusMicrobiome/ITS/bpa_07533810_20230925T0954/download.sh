...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/ITS/bpa_07533810_20230925T0954
...
if [ ! -f tmp/bpa_07533810_20230925T0954_urls.txt ]; then
  echo "tmp/bpa_07533810_20230925T0954_urls.txt not found"
  echo
...
done < tmp/bpa_07533810_20230925T0954_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_07533810_20230925T0954_md5sum.txt 2>&1 | tee tmp/md5sum.log