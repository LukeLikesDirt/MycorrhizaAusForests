...
cd /data/group/frankslab/project/LFlorence/MycorrhizaAusForests/data/AusMicrobiome/ITS/bpa_4f999bb9_20230717T0504
...
if [ ! -f tmp/bpa_4f999bb9_20230717T0504_urls.txt ]; then
  echo "tmp/bpa_4f999bb9_20230717T0504_urls.txt not found"
  echo
...
done < tmp/bpa_4f999bb9_20230717T0504_urls.txt

echo "Data download complete. Verifying checksums:"
md5sum -c tmp/bpa_4f999bb9_20230717T0504_md5sum.txt 2>&1 | tee tmp/md5sum.log